...
const serviceLists = [
    {id:1, title: "Service", des: "Delight with our flavors and  presentation", img: "/images/home/services/icon1.png"},
    {id:2, title: "Fast delivery", des: "We deliver your order promptly to your door", img: "/images/home/services/icon2.png"},
    {id:3, title: "Online Ordering", des: "Explore menu & order with ease using our Website", img: "/images/home/services/icon3.png"},
]
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-12">
        <div className="md:w-1/2">
          <div className="text-left md:w-4/5">
            ...
            <h2 className="title">Future Flavor's Services</h2>
